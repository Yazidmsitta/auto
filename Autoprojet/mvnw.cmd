...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    ...
    powershell -Command "&{"^
        ...
        "try {"^
            ...
            "$url = \"%MVNW_REPOURL%/org/apache/maven/wrapper/maven-wrapper/3.2.0/maven-wrapper-3.2.0.jar\";"^
            "$outputFile = \"%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar\";"^
            "Write-Host \"Downloading Maven Wrapper...\";"^
            "$webClient.DownloadFile(\"$url\", \"$outputFile\");"^
            "Write-Host \"Maven Wrapper downloaded successfully.\";"^
        "} catch {"^
            "Write-Host \"Error downloading Maven Wrapper: $_\";"^
            "exit 1;"^
        "}"^
    "}"
